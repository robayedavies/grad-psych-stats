...
2.1 I have written a chapter discussing the main ideas and setting out the practical steps you can follow to start to develop the skills required to analyse multilevel structured data.
...
@baayen2008 [see also @Barr2013a; @judd2012] discuss mixed-effects models with crossed random effects. This is the topic we shall discuss next.
