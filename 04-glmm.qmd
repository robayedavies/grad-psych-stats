...
\begin{description}
\item[Categorical outcomes] cannot be analyzed using linear models (ANOVA or t-test or linear models or linear mixed-effects models) without having to make some important compromises.
\end{description}
...
## Understanding the Generalized part of the Generalized Linear Mixed-effects Models in practical terms
...
## The data we will work with: the Ricketts word learning study {#word-learning}
...
#### Outcome (dependent) variables -- Orthographic post-test
...
### Code categorical factors {#recode}
...
#### Category coding practicalities
...
### Specify a random intercepts model
...
### GLMMs and hypothesis tests {#hypothesis}
...
## Examining if we should include random effects
...
#### Random effects of subjects and stimulus items on intercepts
...
#### Random effects of subjects and stimulus words on the slope of the Orthography effect
...
#### Random effects of subjects and stimulus words on the slope of the Instructions effect
...
#### Adding effects a bit at a time
...
#### Random effects of subjects on the slope of the consistency effect
...
#### Random effects of subjects and stimulus words on the slope of the time effect
...
### Comparison of models varying in random effects
