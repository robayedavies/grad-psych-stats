...
We can illustrate this by plotting, in @fig-BLUPS-prediction, the differences as estimated -- technically, *predicted* -- by the mixed-effects model that we have been examining.
